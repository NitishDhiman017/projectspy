...
STATUS_MESSAGES = ["never give up"]
print "---------welcome to spy chat secret app--------"
print"----------just enter your details---------------"
...
def select_a_friend() :
        ...
        while select > totalfriends or select <=0 :
            select =int(raw_input("No name exist in  this position in your friend list. please enter again :"))
